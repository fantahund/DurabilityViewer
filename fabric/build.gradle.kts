...
loom {
    if (project(":common").file("src/main/resources/durabilityviewer.accesswidener").exists())
        accessWidenerPath.set(project(":common").file("src/main/resources/durabilityviewer.accesswidener"))
